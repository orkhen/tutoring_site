      ...
      <div className="contacts-container">
        ...
        <div className="contacts-content">
          <div className="contacts-socials">
            <div className="contacts-whatsapp" data-aos="fade-right">
            ...
            <div className="contacts-linkedin" data-aos="fade-right">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
              ...
              <a href='https://www.linkedin.com/in/orkhen/'>Orkhan Aliyev</a>
            </div>

            <div className="contacts-instagram" data-aos="fade-right">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
              ...
              <a href='https://www.instagram.com/codingwithorkhan?igsh=MTQxejR0Z3V2dmZhNg%3D%3D&utm_source=qr'>@codingwithorkhan</a>
            </div>
          </div>

          <div className="contacts-email">
            <div className="contacts-email-header d-flex">
              <div className="contacts-email-from" data-aos="fade-up">
              ...
              <div className="contacts-email-subject" data-aos="fade-up">
                <h5>Mövzu:</h5>
                <input 
                  type='text' 
                  name='subject' 
            ...
            <div className="contacts-email-content d-flex flex-column" data-aos="fade-up">
              <h5>Məzmun:</h5>
              <textarea 
                name="content" 
                cols="60" 
                rows="10" 
                placeholder='Sizi maraqlandıran sualları qeyd edin...' 
